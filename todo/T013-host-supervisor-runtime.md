...
- Resume lease handling now also refreshes workflow/session artifacts after lease acquisition before continuing, preventing stale supervisor ticks from re-running workflows that another tick already completed.
