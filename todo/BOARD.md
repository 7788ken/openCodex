...
- `T021` — partially implemented: installed bridge state, transparent `codex` shim install/repair/status flow, and the first bridge-owned live-session slice are in place; the remaining gap is an attachable PTY/inbox runtime and remote attach path
